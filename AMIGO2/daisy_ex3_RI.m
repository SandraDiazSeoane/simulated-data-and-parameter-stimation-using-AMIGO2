...
%%%
inputs.pathd.short_name='daisy_ex3';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("daisy_ex3_data.mat",'tspan','xzero','params','data_noise');
...
%==================================
 ...
 inputs.exps.obs{1}=char('y1=x1','y2=x4');
