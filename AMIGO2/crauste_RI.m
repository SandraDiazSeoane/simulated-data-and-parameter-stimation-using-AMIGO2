...
%%%
inputs.pathd.short_name='crauste';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("crauste_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=-x1 * p1 - x1 * x5 * p9',...  
                 'dx2=x1 * x5 * p9 - x2^2 * p2 - x2 * p10 + x2 * x5 * p12', ...
                 'dx3=x3 * p10 - x3 * p11 - x3^2 * p4 - x2 * x3 * p3', ...
                 'dx4=x3 * p11 - p5 * x4', ...
                 'dx5=x5^2 * p13 - x5 * p6 - x2 * x5 * p7 - x3 * x5 * p8');
...
%==================================
 ...
 inputs.exps.obs{1}=char('y1=x1','y2=x2', 'y3=x3+x4', 'y4=x5');
