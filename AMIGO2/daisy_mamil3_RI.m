...
%%%
inputs.pathd.short_name='daisy_mamil3';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("daisy_mamil3_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=-(p3 + p4 + p5) * x1 + p1 * x2 + p2 * x3',...  
                 'dx2=p3 * x1 - p1 * x2', ...
                 'dx3=p4 * x1 - p2 * x3');
