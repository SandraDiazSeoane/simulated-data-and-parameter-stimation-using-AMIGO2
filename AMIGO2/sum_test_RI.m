...
%%%
inputs.pathd.short_name='sum_test';                       % To identify figures and reports for a given problem 
                                                     % ADVISE: the user may introduce any names related to the problem at hand 
inputs.pathd.runident='r2';                         % [] Identifier required in order not to overwrite previous results
...
% MODEL RELATED DATA
%============================
data=load("sum_test_data.mat",'tspan','xzero','params','data_noise');
...
inputs.nlpsol.multi_starts=100;                      % [] Number of different initial guesses to run local methods in the multistart approach
