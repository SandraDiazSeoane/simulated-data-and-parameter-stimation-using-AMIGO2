...
%%%
inputs.pathd.short_name='global_unident_test';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("global_unident_test_data.mat",'tspan','xzero','params','data_noise');
