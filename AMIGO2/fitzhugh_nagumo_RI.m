...
%%%
inputs.pathd.short_name='fitzhugh_nagumo';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("fitzhugh_nagumo_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=p1 * (x1 - x1^3 / 3 + x2)',...  
                 'dx2=1 / p1 * (x1 - p2 + p3 * x2)');
...
%	p4 : 3.9628e-01  +-  2.0372e-01 (5.1408e+01 percent);  
 ...
 %%%
 inputs.PEsol.global_theta_guess= [0.25, 0.5, 0.75];                            % BEST solution achieved in optimization
 
 %%%
 FIM_conf_interval=0.1*ones(1,3);
