...
%%%
inputs.pathd.short_name='biohydrogenation';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("biohydrogenation_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=-p1 * x1 / (p2 + x1)',...  
                 'dx2=p1 * x1 / (p2 + x1) - p3 * x2 / (p4 + x2 + x3)', ...
                 'dx3=p3 * x2 / (p4 + x2 + x3) - p5 * x3 * (p6 - x3) / p6', ...
                 'dx4=p5 * x3 * (p6 - x3) / p6');
