...
%%%
inputs.pathd.short_name='hiv';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("hiv_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=p1 - p2 * x1 - p3 * x1 * x3',...  
                 'dx2=p3 * x1 * x3 - p4 * x2', ...
                 'dx3=p5 * x2 - p6 * x3', ...
                 'dx4=p7 * x1 * x2 * x4 - p7 * p8 * x2 * x4 - p9 * x4', ...
                 'dx5=p7 * p8 * x2 * x4 - p10 * x5');
...
%==================================
 ...
 inputs.exps.obs{1}=char('y1=x4','y2=x5','y3=x1','y4=x2+x3');
 ...
 inputs.exps.t_s{1}=data.tspan;                                % Number of sampling times                                                       
%==================================
