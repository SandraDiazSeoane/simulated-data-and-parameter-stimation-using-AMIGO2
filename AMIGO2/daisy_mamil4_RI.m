...
%%%
inputs.pathd.short_name='daisy_mamil4';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("daisy_mamil4_data.mat",'tspan','xzero','params','data_noise');
...
inputs.model.eqns=...                                % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
            char('dx1=-p1 * x1 + p2 * x2 + p3 * x3 + p4 * x4 - p5 * x1 - p6 * x1 - p7 * x1',...  
                 'dx2=-p2 * x2 + p5 * x1', ...
                 'dx3=-p3 * x3 + p6 * x1', ...
                 'dx4=-p4 * x4 + p7 * x1');
