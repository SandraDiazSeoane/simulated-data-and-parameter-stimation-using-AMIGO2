...
%%%
inputs.pathd.short_name='substr_test';                       % To identify figures and reports for a given problem 
...
% MODEL RELATED DATA
%============================
data=load("substr_test_data.mat",'tspan','xzero','params','data_noise');
...
%==================================
 ...
 inputs.exps.obs{1}=char('y1=x1','y2=x2','y3=x3');
...
%	p4 : 3.9628e-01  +-  2.0372e-01 (5.1408e+01 percent);  
 ...
 %%%
 inputs.PEsol.global_theta_guess= [0.1
     0.2
     0.3]';                            % BEST solution achieved in optimization
 
 %%%
 FIM_conf_interval=[0.045 0.045 0.045];
